...
**Dependencies:** Google Places API (€200/mo), MapLibre GL  
...
4. **Defer features:** Move sustainability metrics to v2.2.1
...
### v3.0 Vision (Q3 2026)
- **AI-powered features** (tour planning, contract generation, smart suggestions)
...
**Note:** AI features deferred to v3.0 to focus v2.2 on core stability, security, and performance.
...
### Week 1-2: xlsx Migration (COMPLETED ✅)
**Commit:** f191614 - "fix: replace xlsx with exceljs + papaparse"
- ✅ Removed xlsx dependency (CVE-2023-30533, CVE-2024-22363 resolved)
- ✅ Installed exceljs + papaparse
- ✅ Refactored src/lib/excelExport.ts to async API
- ✅ Created src/lib/exportToCSV.ts for CSV exports
- ✅ Updated SECURITY.md (vulnerability marked RESOLVED)
- **Status:** SHIPPED ✅

### Week 2-3: Audit Logging Infrastructure (COMPLETED ✅)
**Commits:** 03f6d7d, 5f239c9, 3788a6a
- ✅ Created src/types/auditLog.ts (245 lines) - 60+ actions, 12 categories
- ✅ Built src/services/AuditLogService.ts (445 lines) - Real-time, filtering, retention
- ✅ Integrated audit logging into critical services:
  * Link invitations (4 operations)
  * Finance (3 operations with change tracking)
  * Organization (imports added, ready for integration)
- ✅ Deployed Firestore rules (immutable audit logs)
- ✅ Deployed 6 composite indexes for efficient queries
- **Status:** SHIPPED ✅

### Week 4-5: MFA Enforcement (IN PROGRESS 🚧)
**Commit:** edf6781 - "feat: implement WebAuthn MFA with biometric support"
- ✅ Installed @simplewebauthn/browser + @simplewebauthn/server (22 packages)
- ✅ Created src/types/webauthn.ts (280 lines) - Complete type safety
- ✅ Built src/services/WebAuthnService.ts (483 lines):
  * Device registration with FIDO2 spec
  * Biometric authentication (TouchID, FaceID, Windows Hello)
  * External security keys (YubiKey, USB/NFC/BLE)
  * Backup codes with SHA-256 hashing
  * MFA enrollment status tracking
- ✅ Created src/components/security/MFASettings.tsx (435 lines):
  * Device management UI
  * Backup codes generation/download
  * Real-time enrollment status
- ✅ Added Firestore security rules for MFA collections
- ✅ Added 27 i18n keys (EN + ES)
- 🔄 **Pending:** Integrate MFASettings into Settings page
- 🔄 **Pending:** Enforce MFA for admin/owner roles
- 🔄 **Pending:** Testing with actual biometric devices
- **Status:** CORE COMPLETE, INTEGRATION PENDING

### Week 2-3: Audit Log Viewer UI (PENDING 📋)
- 📋 Create src/components/audit/AuditLogViewer.tsx
- 📋 Integrate into Timeline page
- 📋 Real-time updates via auditLogService.subscribe()
...
### v2.2 is ready when:
- [x] xlsx vulnerability removed (Week 1-2) ✅
- [x] Audit logging infrastructure (Week 2-3) ✅
- [ ] MFA enforcement complete (Week 4-5) - 80% done
- [ ] Audit Log Viewer UI (Week 2-3) - Not started
