                ...
                >
                    <div className="glass rounded-2xl border border-white/20 shadow-2xl overflow-hidden">
                        ...
                        <div className="flex items-center gap-3 px-4 py-3 border-b border-white/10">
                            ...
                            />
                            <kbd className="px-2 py-1 rounded bg-white/10 text-xs text-white/60 font-mono">ESC</kbd>
                        </div>
                                ...
                                <div className="py-2">
                                    {filteredCommands.map((cmd, index) => (
                                        ...
                                        >
                                            ...
                                            {index === selectedIndex && (
                                                <kbd className="px-2 py-1 rounded bg-white/10 text-xs text-white/60 font-mono flex-shrink-0">
                                                    ↵
                                                </kbd>
                                            )}
                                        </button>
