    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          {/* Card */}
          <motion.div
            className="relative glass rounded-lg p-5 md:p-6 w-[90vw] max-w-[480px] border border-white/10 shadow-2xl backdrop-blur-md space-y-4"
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2.5 rounded-lg bg-white/5 border border-white/10 hover:border-white/20 focus:border-accent-400 text-white placeholder-white/40 text-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-accent-400/50"
                      autoFocus
                    />
                  </div>
                  ...
                  <div className="flex gap-2 pt-2">
                    <motion.button
                      type="button"
                      onClick={onClose}
                      className="flex-1 px-3 py-2.5 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 text-white text-sm font-medium transition-all"
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                    >
                      Cancel
                    ...
                    <motion.button
                      type="button"
                      onClick={() => setStep(2)}
                      className="flex-1 px-3 py-2.5 rounded-lg bg-white/10 border border-white/20 hover:bg-white/15 text-white text-sm font-medium transition-all"
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                    >
                      More Details
                ...
                >
                  ...
                  <div className="p-3 bg-white/5 rounded-lg border border-white/10 space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-semibold text-white">{data.city}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-white/60">Country:</span>
                      <span className="text-sm font-semibold text-white">{data.country}</span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 rounded-lg bg-white/5 border border-white/10 hover:border-white/20 focus:border-accent-400 text-white placeholder-white/40 text-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-accent-400/50"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="w-full px-3 py-2 rounded-lg bg-white/5 border border-white/10 hover:border-white/20 focus:border-accent-400 text-white placeholder-white/40 text-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-accent-400/50 resize-none h-20"
                    />
                  </div>
