...
const TravelEventModal: React.FC<Props> = ({ open, onClose, initialData, onSave }) => {
  ...
  return (
    <div role="dialog" aria-labelledby="travel-modal-title" aria-modal="true" className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <motion.div
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/10">
          <h2 id="travel-modal-title" className="text-xl font-semibold text-white">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[calc(100vh-200px)] overflow-y-auto">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-sm font-medium text-white/80 mb-2">From (Origin)</label>
              <input
                type="text"
                placeholder="e.g., MAD"
            ...
            <div>
              <label className="block text-sm font-medium text-white/80 mb-2">To (Destination)</label>
              <input
                type="text"
                placeholder="e.g., NYC"
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-sm font-medium text-white/80 mb-2">Departure Time</label>
              <input
                type="time"
            ...
            <div>
              <label className="block text-sm font-medium text-white/80 mb-2">Arrival Time</label>
              <input
                type="time"
          ...
          {/* Flight Details */}
          <div>
            <label className="block text-sm font-medium text-white/80 mb-2">Booking Locator / Reference</label>
            <input
              type="text"
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="block text-sm font-medium text-white/80 mb-2">Flight Number</label>
              <input
                type="text"
