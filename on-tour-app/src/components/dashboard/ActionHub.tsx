      ...
      <div className="flex flex-wrap gap-2 text-sm">
        <button
          ...
          className={`px-3 py-1.5 rounded-md text-xs transition-all ${selectedCategory === 'all'
            ...
            : 'bg-slate-200 dark:bg-white/10 hover:bg-white/20'
            }`}
        >
            ...
            filteredActions.map((action) => {
              ...
              return (
                <motion.div
                  ...
                  className="border border-slate-200 dark:border-white/10 rounded-lg overflow-hidden cursor-pointer transition-all hover:border-slate-300 dark:hover:border-white/20 hover:bg-slate-100 dark:bg-white/5 gpu-accelerate list-item-optimize"
                >
                  ...
                  <div className="p-3">
                    ...
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex items-center gap-1.5 px-2 py-1 rounded bg-slate-200 dark:bg-slate-200 dark:bg-white/10 text-xs">
                      ...
                      <button className="px-2.5 py-1 rounded bg-slate-200 dark:bg-slate-200 dark:bg-white/10 hover:bg-white/20 text-xs font-medium transition-all hover-lift">
                        {action.actionText}
                      </button>
                    </div>
                  </div>
