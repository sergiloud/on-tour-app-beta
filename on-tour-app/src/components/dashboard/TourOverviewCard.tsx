  ...
  return (
    <Card className="p-0 flex flex-col overflow-hidden" aria-label="Tour overview">
      ...
      <header className="px-4 pt-4 pb-3 bg-gradient-to-r from-slate-900/50 to-slate-800/30 border-b border-white/5">
        ...
        <div className="text-xs opacity-70">{t('dashboard.next30days')} • {data.totalFuture} total {t('dashboard.showsBooked')}</div>
      </header>
      ...
      <div className="p-4 space-y-4">
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-xs font-medium text-accent-400">{t('dashboard.nextShow')}</span>
                </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="glass rounded-lg p-3">
            ...
            <div className="text-xs opacity-60 mt-0.5">{t('dashboard.offersPending')}</div>
          </div>
        </div>

        {/* Weekly Revenue Chart */}
        <div className="glass rounded-lg p-3">
          <div className="text-xs font-medium mb-2 opacity-80">{t('dashboard.next30days')} Revenue</div>
...
TourOverviewCard.displayName = 'TourOverviewCard';
