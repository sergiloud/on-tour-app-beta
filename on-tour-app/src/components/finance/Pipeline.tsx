...
const Pipeline: React.FC = () => {
  ...
  <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-1 text-[11px] opacity-80">
          <span className="px-1.5 py-0.5 rounded bg-white/5 border border-white/10">100%</span>
          <span className="px-1.5 py-0.5 rounded bg-white/5 border border-white/10">60%</span>
          <span className="px-1.5 py-0.5 rounded bg-white/5 border border-white/10">30%</span>
        </div>
        <button className="px-2 py-1 rounded bg-white/10 hover:bg-white/15 border border-white/10 text-[11px]" onClick={copyReminder}>{t('common.reminder')||'Reminder'}</button>
      </div>
