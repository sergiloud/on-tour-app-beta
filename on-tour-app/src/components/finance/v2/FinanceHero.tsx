...
export const FinanceHero: React.FC = () => {
    ...
    return (
        <div className="space-y-6 lg:space-y-8">
            ...
            <div className="glass rounded-xl border border-white/10 backdrop-blur-sm px-6 py-4 bg-gradient-to-r from-transparent via-white/5 to-transparent hover:border-white/20 transition-all duration-300">
                <div className="flex items-center gap-3">
                    <div className="w-1 h-6 rounded-full bg-gradient-to-b from-accent-500 to-blue-500" />
                    <div>
                        <div className="text-xs font-medium text-white/40 uppercase tracking-wider mb-0.5">
                            Current Period
                        </div>
