    ...
    return (
        <div className={`relative z-10 grid gap-6 sm:grid-cols-2 w-full max-w-2xl ${className}`}>
            <div className="glass p-5 flex flex-col gap-4">
                ...
                <div className="text-3xl font-semibold tracking-tight tabular-nums">{formatCurrency(yearNet)}</div>
                ...
                <div className="flex-1">
                    ...
                    <div className="flex gap-6">
                        ...
                        <div>
                            ...
                            <div className="font-semibold tracking-tight tabular-nums">{formatCurrency(pending)}</div>
                        </div>
                        <div>
                            <div className="text-xs" style={{ color: 'var(--text-secondary)' }}>Net (Month)</div>
                            <div className="font-semibold tracking-tight tabular-nums">{formatCurrency(monthNet)}</div>
                        </div>
                    </div>
                </div>
                <MapPreview
