                    ...
                    {showStats && isActive && (
                        ...
                        >
                            <div className="px-4 py-3 space-y-3">
                                ...
                                {/* Avg per Show */}
                                <div className="flex items-center justify-between">
                                    <span className="text-xs text-white/60">Avg per Show</span>
                                    <span className="text-sm font-semibold text-white tabular-nums">
                                ...
                                {stats.topCity && (
                                    <div className="pt-2 border-t border-white/10">
                                        <div className="text-[10px] text-white/50 mb-1">Top City</div>
                                        <div className="flex items-center justify-between">
                                ...
                                {stats.topCountry && (
                                    <div className="pt-2 border-t border-white/10">
                                        <div className="text-[10px] text-white/50 mb-1">Top Country</div>
                                        <div className="flex items-center justify-between">
                                            <span className="text-xs font-medium text-white">
                            ...
                            <div className="px-4 py-2 bg-white/5 border-t border-white/10">
                                <div className="text-[10px] text-white/50 mb-2">Revenue Tiers</div>
