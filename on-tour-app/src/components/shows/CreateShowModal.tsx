          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
        ...
        return (
          <div className="space-y-6">
            <div className="bg-white/5 rounded-lg p-6 space-y-4">
              <h3 className="text-lg font-semibold text-white">Show Summary</h3>

              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  <span className="text-slate-400">Name:</span>
                  <p className="text-white font-medium">{sanitizeName(formData.name)}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-white font-medium">{sanitizeName(formData.city)}, {formData.country}</p>
                </div>
                <div>
                  <span className="text-slate-400">Venue:</span>
                  <p className="text-white font-medium">{sanitizeName(formData.venue)} ({formData.capacity.toLocaleString()} capacity)</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-white font-medium">{formData.ticketSalesPercentage}%</p>
                </div>
                <div>
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-slate-900 border border-white/20 rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden"
