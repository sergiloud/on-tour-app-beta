...
import { loadShows, createNewShowDefaults, addLocalShow } from '../core/shows';
import { computeShowFinance, getCosts, addCost, deleteCost, getCostById, restoreCost } from '../core/show-finance';
import { showConfirmModal, openModal } from '../../../shared/modals';
import { listAgencies } from '../../../shared/agencies';
import { euros } from '../../../data/demo';
import { debounce, animateButtonSave } from '../../../shared/utils';
