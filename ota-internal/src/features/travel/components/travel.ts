...
import { DashComponent, DashComponentCtx, registerComponent } from '../../../features/dashboard/core/component-registry';
import { patchList } from '../../../features/dashboard/core/dom-utils';
