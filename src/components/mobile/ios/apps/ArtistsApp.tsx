          ...
          {filteredArtists.map((artist, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-2.5 text-sm">
                ...
                <span className={`text-xs px-2 py-0.5 rounded-md ${getStatusColor(artist.status)}`}>
                  {artist.status}
                </span>
              </div>
            </motion.div>
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <div className="flex-1">
                <h2 className="text-sm font-bold">{selectedArtist.name}</h2>
                <p className="text-white/60">{selectedArtist.genre}</p>
                <div className="flex items-center gap-2 mt-1">
                  <Star className="w-4 h-4 text-yellow-400 fill-yellow-400" />
                  <span className="font-semibold">{selectedArtist.rating}</span>
                  <span className={`text-xs px-2 py-0.5 rounded-md ml-2 ${getStatusColor(selectedArtist.status)}`}>
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg px-4 py-3">
                ...
                <div className="text-lg font-bold">{selectedArtist.pastShows}</div>
              </div>
