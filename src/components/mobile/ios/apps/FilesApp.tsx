          ...
          {filteredFiles.map((file, index) => {
            ...
            return (
              <motion.div
                ...
                className={`bg-gradient-to-br ${getFileColor(file.type)} border rounded-xl p-4 cursor-pointer hover:scale-[0.98] transition-transform`}
              >
      ...
      {selectedFile && (
        ...
        >
          <motion.div
            ...
            className="w-full bg-gradient-to-b from-gray-800 to-gray-900 rounded-t-3xl p-6"
          >
            ...
            <div className="flex items-start gap-4 mb-6">
              {(() => {
                ...
                return (
                  <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${getFileColor(selectedFile.type)} border flex items-center justify-center`}>
                    <Icon className="w-8 h-8" />
                  </div>
                );
              })()}
              <div className="flex-1">
                <h2 className="text-lg font-bold mb-1">{selectedFile.name}</h2>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl py-3 font-semibold flex items-center justify-center gap-2 hover:from-blue-600 hover:to-blue-700 transition-all"
              >
              ...
              <button
                onClick={() => setSelectedFile(null)}
                className="bg-white/10 rounded-xl py-3 font-semibold hover:bg-white/20 transition-all"
              >
                Close
              </button>
            </div>
