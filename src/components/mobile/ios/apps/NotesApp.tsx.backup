      ...
      <div className="px-6 pt-6 pb-4 border-b border-white/10">
        ...
        <div className="relative">
          <input
            ...
            className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 pl-10 text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-yellow-500/50"
          />
        ...
        <div className="space-y-2">
          {filteredNotes.map((note, index) => (
            <motion.div
              ...
              } border rounded-xl p-4 cursor-pointer hover:scale-[0.98] transition-transform relative`}
            >
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className="bg-white/10 rounded-xl py-3 font-semibold hover:bg-white/20 transition-all flex items-center justify-center gap-2"
              >
              ...
              <button
                onClick={() => setSelectedNote(null)}
                className="bg-gradient-to-r from-yellow-500 to-orange-500 rounded-xl py-3 font-semibold hover:from-yellow-600 hover:to-orange-600 transition-all"
              >
                Close
              </button>
            </div>
