          ...
          {filteredReports.map((report, index) => {
            ...
            return (
              <motion.div
                ...
                className={`bg-gradient-to-br ${getTypeColor(report.type)} border rounded-2xl p-4 cursor-pointer hover:scale-[0.98] transition-transform`}
              >
            ...
            {selectedReport.revenue !== undefined && (
              <div className="space-y-3 mb-6">
                <div className="bg-gradient-to-r from-green-500/20 to-green-600/20 border border-green-500/30 rounded-xl p-4">
                  ...
                  <div className="text-2xl font-bold text-green-400">{formatCurrency(selectedReport.revenue)}</div>
                </div>
                ...
                {selectedReport.expenses !== undefined && (
                  <div className="bg-gradient-to-r from-red-500/20 to-red-600/20 border border-red-500/30 rounded-xl p-4">
                    ...
                    <div className="text-2xl font-bold text-red-400">{formatCurrency(selectedReport.expenses)}</div>
                  </div>
                )}
                ...
                {selectedReport.shows !== undefined && (
                  <div className="bg-white/5 rounded-xl p-4">
                    ...
                    <div className="text-2xl font-bold">{selectedReport.shows}</div>
                  </div>
                )}
              </div>
            )}
