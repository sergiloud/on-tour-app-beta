...
export const TeamApp: React.FC<AppComponentProps> = () => {
  ...
  const getActivityIcon = useCallback((type: 'show' | 'expense' | 'task') => {
    switch (type) {
      case 'show':
        return Music;
      case 'expense':
    ...
    <div className="h-full overflow-y-auto bg-ink-950">
      ...
      <div className="sticky top-0 z-10 bg-gray-900/60 backdrop-blur-xl border-b border-white/10 px-5 pt-5 pb-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold text-white tracking-tight">Equipo</h1>
            <p className="text-white/50 text-xs mt-0.5">{team.length} miembros</p>
          </div>
          <motion.button
            whileTap={{ scale: 0.95 }}
        ...
        <div className="relative mb-6">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder:text-white/30 focus:outline-none focus:border-accent-500/50 transition-colors"
          />
        </div>
      </div>
            ...
            >
              <div className="p-6">
                ...
                <div className="flex items-center gap-3 mb-5">
                  <div className="relative">
                    <div className="w-16 h-16 rounded-full bg-gradient-to-br from-accent-500 to-accent-600 flex items-center justify-center text-black font-bold text-xl shadow-lg">
                  ...
                  <div className="flex-1">
                    <h2 className="text-sm font-bold text-white mb-1">{selectedMember.name}</h2>
                ...
                <div className="space-y-3 mb-6">
                  <a
                    ...
                    className="flex items-center gap-2.5 px-3 py-2.5 bg-white/5 rounded-lg hover:bg-white/10 transition-colors"
                  >
                ...
                <div className="flex gap-3">
                  <motion.button
                    whileTap={{ scale: 0.98 }}
                    className="flex-1 py-2.5 bg-accent-500 text-black font-semibold rounded-lg flex items-center justify-center gap-2"
                  >
