...
const loaders: Record<string, Loader> = {
  ...
  '/dashboard/timeline': () => import('../pages/dashboard/TimelinePage'),
  '/dashboard/roadmap': () => import('../features/roadmap/pages/RoadmapPage'),
...
export const prefetch = {
  ...
  timeline: () => prefetchByPath('/dashboard/timeline'),
  roadmap: () => prefetchByPath('/dashboard/roadmap'),
